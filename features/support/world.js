...
var World = function World(callback) {
  ...
  this.get = function(path, callback) {
    ...
    //console.log("This final uri before GET: " + uri)
    request.get({url: uri, headers: {'User-Agent': 'request', 'content-type': 'application/json'}},
  ...
  this.post = function(path, requestBody, callback) {
    ...
    request({url: uri, body: requestBody, method: 'POST',
      ...
      self.lastRequest = requestBody
      self.lastResponse = response
      return callback(null, self.lastResponse.headers.location)
    })
  }
